    ...
    switch (name) {
      ...
      case "ownerName":
        return value.length < 2
          ? "Owner name must be at least 2 characters long"
          : "";
      case "storeName":
        return value.length < 2
      ...
      case "slogan":
        ...
        if (value.length < 5) {
          return "Slogan must be at least 5 characters long";
        } else if (sloganWordCount > 10) {
          return "Slogan must not exceed 10 words";
        }
        return "";
      case "storeDescription":
        const descriptionWordCount = value.trim().split(/\s+/).length;
        if (value.length < 10) {
          return "Store description must be at least 10 characters long";
        } else if (descriptionWordCount > 20) {
          return "Store description must not exceed 20 words";
        }
        return "";
      ...
      case "openingDay":
      case "closingDay":
        return value === "" ? `${name} must be selected` : "";
      default:
        return "";
    }
  };
